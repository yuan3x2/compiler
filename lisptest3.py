...
def p_num_op(p):
    ...
    # if type(p[3]) != NumberNode:
    #     print("type Error!!!") 
    #     exit()

    # if type(p[2]) == '+' or type(p[2]) == '\*' or type(p[2]) == '=':
    #     for num in p[4]:
    #         if type(num) != NumberNode:
    #             print("type Error!!!")
    #             exit()
...
def p_logical_op(p):
    ...
    # if type(p[3]) != BoolNode:
    #     print("type Error!!!")
    #     exit()

    # if p[2] == "and" or p[2] == "or":
    #     for num in p[4]:
    #         if type(num) != BoolNode:
    #             print("type Error!!!")
    #             exit()
...
def postorder(node):
    ...
    if isinstance(node, NumberNode):
        ...
        if node.operator == '+':
            ...
            if isinstance(node.right, list):
                ...
                for num in node.right:
                    # print(num.value)
                    # check type is num
                    if(type(num.value) != int):
                        print("type Error!!!")
                        exit()
                    sum += num.value
                node.value = node.left.value + sum
            else:
                if type(node.left.value) != int or type(node.right.value) != int:
                    print("type Error!!!")
                    exit()
        ...
        if node.operator == 'and':
            ...
            if type(node.operands[0].value) != bool:
                print("type Error!!!")
                exit()
...
if __name__ == "__main__":
    # for i in range(1, 9):
        ...
        #     args.clear()
        #     parms.clear()
        #     file = open(f"final-auto/testdata/0{i}_{j}_hidden.lsp", "r")
    ...
    file = open("final-auto/testdata/b2_1_hidden.lsp", "r")
    data = file.read()
    if data:
        ast = parser.parse(data)   
        postorder(ast)
